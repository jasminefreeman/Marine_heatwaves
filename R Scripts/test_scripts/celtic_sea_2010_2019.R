...
run_month <- function(i) {
  ...
  model <- e2e_read("Celtic_Sea_MA", "2010-2019-CNRM-ssp126")
...
saveRDS(res,"C:/Users/xvb24200/OneDrive - University of Strathclyde/Marine_heatwaves/Objects/celtic_sea2010_2019.RDS")
...
res <- readRDS("C:/Users/xvb24200/OneDrive - University of Strathclyde/Marine_heatwaves/Objects/celtic_sea2010_2019.RDS") # change this directory
...
ggsave("C:/Users/xvb24200/OneDrive - University of Strathclyde/Marine_heatwaves/Results/celtic_sea2010_2019.png",
       height = 4000,
       width = 6000,
       units = "px",
       dpi = 400)
...
ggsave("C:/Users/xvb24200/OneDrive - University of Strathclyde/Marine_heatwaves/Results/celtic_sea2010_2019-BAR.png",
       height = 4000,
       width = 6000,
       units = "px",
       dpi = 400)
